		...
		<div id="content">
			...
			<div id="element-box" class="login well">
				<?php if ($loginLogoFile = $this->params->get('loginLogoFile')) : ?>
					<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/adm-logo_login.png" title="" alt="<?php echo $sitename; ?>" />                    
				<?php else: ?>
                	<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/adm-logo_login.png" alt="<?php echo $sitename; ?>" />
					<!--img src="<?php //echo $this->baseurl; ?>/templates/<?php //echo $this->template; ?>/images/joomla.png" alt="<?php //echo $sitename; ?>" /-->
				<?php endif; ?>
				<hr />
				<jdoc:include type="message" />
				<jdoc:include type="component" />
                <div class="wrap_developer" style="min-height: 40px;">
                <?php /*
					<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/developer-logo_login.png" title="Разработка шаблона" alt="<?php echo $sitename; ?>" /> */?>	
                </div>
			</div>
			<noscript>
