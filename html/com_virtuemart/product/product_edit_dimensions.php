...
<!--<script src="/components/com_jce/editor/tiny_mce/tiny_mce.js"></script>-->
<script src="https://cloud.tinymce.com/stable/tinymce.min.js"></script>
<script>
    document.addEventListener("DOMContentLoaded", function () {
        var tinymceSelectors = {
            'textarea#field-0-customfield_value' : {
                height: 200,
            },
            'textarea#field-9-customfield_value' : {
                height: 200,
            },
        }
        console.log('product_edit_dimensions:->tinymceSelectors >>> ' , tinymceSelectors );

        for ( var Key in tinymceSelectors )
        {

            tinymce.init({
                selector: Key ,
                height: tinymceSelectors[Key].height ,
                menubar: false,
                plugins: [
                    "textcolor",
                ...
                toolbar: 'undo redo | forecolor backcolor | formatselect | ' +
            ...
            console.log('product_edit_dimensions:->tinymceSelectors >>> ' , tinymceSelectors );
            console.log('product_edit_dimensions:->tinymceSelectors >>> ' , tinymceSelectors[Key] );
            console.log('product_edit_dimensions:->tinymceSelectors >>> ' , Key );
   ...
   <tbody>
    ...
    <tr class="row0">
		<th style="text-align:right;"><?php echo vmText::_('Диаметр или ширина') ?></th>
      <td>
